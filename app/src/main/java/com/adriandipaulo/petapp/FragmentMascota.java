...
public class FragmentMascota extends Fragment {
    ...
    public  void inicializarListaMascotas () {
        ...
        mascotas.add(new Mascotas("Pepe",5,R.drawable.p1,1));
        mascotas.add(new Mascotas("Luna",6,R.drawable.p2,2));
        mascotas.add(new Mascotas("Lupi",6,R.drawable.p3,3));
        mascotas.add(new Mascotas("Tim",6,R.drawable.p4,4));
        mascotas.add(new Mascotas("Fido",6,R.drawable.p5,5));
        mascotas.add(new Mascotas("Loly",6,R.drawable.p6,6));
        mascotas.add(new Mascotas("Sun",6,R.drawable.p7,7));
    }
}