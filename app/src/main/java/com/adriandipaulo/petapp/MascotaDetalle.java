...
import com.adriandipaulo.petapp.adaptadores.MyAdapter2;
...
public class MascotaDetalle extends Fragment {
    ...
    public void inicializarListaMascotas () {
        ...
        mascotas.add(new Mascotas("Loly",6,R.drawable.images4,6));
        mascotas.add(new Mascotas("Loly",6,R.drawable.bf1,6));
        mascotas.add(new Mascotas("Loly",6,R.drawable.bf2,6));
        mascotas.add(new Mascotas("Loly",6,R.drawable.bf3,6));
