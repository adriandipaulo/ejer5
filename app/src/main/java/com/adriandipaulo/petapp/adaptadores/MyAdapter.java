package com.adriandipaulo.petapp.adaptadores;
...
import com.adriandipaulo.petapp.Mascotas;
import com.adriandipaulo.petapp.Pantalla2;
import com.adriandipaulo.petapp.R;
...
import java.util.ArrayList;
    ...
    ArrayList<Mascotas> mascotas_vista;
    Activity activity;
    ...
    public void onBindViewHolder(@NonNull MascotaViewHolder MascotaViewholder, int position) {
        ...
        MascotaViewholder.butthueso.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                final ArrayList<Mascotas> mascotas = Pantalla2.cargarMascotas(mascota.getNombreMascota(), mascota.getVotoMascota(), mascota.getFotoMascota(), mascota.getId_mascota());
            }
        });
